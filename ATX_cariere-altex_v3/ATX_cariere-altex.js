var CariereJSON = [{
  ...
  NumePozitii: [{
    ...
    Email: {
      ...
      BodyFooter: "%0D%0AEchipa Resurse Umane iti multumeste pentru interesul acordat companiei Altex Romania.%0D%0A"
    },
    AcorduriGDPR: {
      AcorduriGDPRHeader: "%0D%0AAi selectat urmatoarele optiuni de prelucrare a datelor:",
      AcordAltex: {
        TextAcordAltex: "%0D%0A - Acord de prelucrare Altex: ",
        ValoareAcordAltex: "Nu"
      },
      AcordParteneriAltex: {
        TextAcordParteneriAltex: "%0D%0A - Acord de prelucrare parteneri Altex: ",
    ...
    Orase: ["Baia Mare", "Brasov", "Bucuresti", "Satu Mare", "Slobozia", "Suceava"],
    Email: {
      MailTo: "recrutare@altex.ro",
    ...
    Orase: ["Alba Iulia", "Baia Mare", "Satu Mare", "Severin", "Slobozia"],
    Email: {
      MailTo: "recrutare@altex.ro",
    ...
    Orase: ["Baia Mare", "Deva", "Roman", "Severin", "Slobozia"],
    Email: {
      MailTo: "recrutare@altex.ro",
    ...
    Orase: ["Baia Mare", "Bucuresti", "Deva", "Oradea", "Satu Mare", "Slobozia", "Suceava"],
    Email: {
      MailTo: "recrutare@altex.ro",
  ...
  NumePozitii: [{
    ...
    Orase: ["Bucuresti"],
    Email: {
      MailTo: "recrutaresediu@altex.ro",
  ...
  NumeDivizie: "Logistica",
  NumePozitii: [{
    NumePozitie: "Gestionar Transport",
    Orase: ["Bucuresti"],
    Email: {
      MailTo: "hrlogistica@altex.ro",
      Subject: "[GESTIONAR TRANSPORT]",
      BodyHeader: "Salut,%0D%0ATe rugam sa atasezi acum CV tau pentru pozitia: ",
      BodyContent: "%0D%0A%0D%0ALasa-ne si numarul tau de telefon aici: 07XX.XXX.XXX%0D%0AIn masura in care CV atasat se potriveste rolului un consultant Resurse Umane te va contacta.%0D%0A",
      BodyFooter: "%0D%0AEchipa Resurse Umane iti multumeste pentru interesul acordat companiei Altex Romania.%0D%0A"
    },
    ...
    NumePozitie: "Curier",
    Orase: ["Bistrita Nasaud", "Brasov", "Bucuresti", "Buzau", "Cluj-Napoca", "Constanta", "Craiova",
      "Ploiesti", "Timisoara"
    ],
    Email: {
      MailTo: "hrlogistica@altex.ro",
    ...
    NumePozitie: "Coordonator Transport",
    Orase: ["Bucuresti"],
    Email: {
      MailTo: "hrlogistica@altex.ro",
      Subject: "[COORDONATOR TRANSPORT]",
      BodyHeader: "Salut,%0D%0ATe rugam sa atasezi acum CV tau pentru pozitia: ",
      BodyContent: "%0D%0A%0D%0ALasa-ne si numarul tau de telefon aici: 07XX.XXX.XXX%0D%0AIn masura in care CV atasat se potriveste rolului un consultant Resurse Umane te va contacta.%0D%0A",
      BodyFooter: "%0D%0AEchipa Resurse Umane iti multumeste pentru interesul acordat companiei Altex Romania.%0D%0A"
    },
    ...
    NumePozitie: "Manipulant Marfuri",
    Orase: ["Braila", "Brasov", "Bucuresti", "Craiova", "Piatra Neamt", "Sibiu", "Suceava", "Timisoara"],
    Email: {
      MailTo: "hrlogistica@altex.ro",
      Subject: "[MANIPULANT MARFURI]",
      BodyHeader: "Salut,%0D%0ATe rugam sa atasezi acum CV tau pentru pozitia: ",
      BodyContent: "%0D%0A%0D%0ALasa-ne si numarul tau de telefon aici: 07XX.XXX.XXX%0D%0AIn masura in care CV atasat se potriveste rolului un consultant Resurse Umane te va contacta.",
      BodyFooter: "%0D%0A%0D%0AIti multumim pentru interesul acordat companiei Altex Romania.%0D%0AEchipa Resurse Umane%0D%0A"
    },
    AcorduriGDPR: {
      AcorduriGDPRHeader: "%0D%0AAi selectat urmatoarele optiuni de prelucrare a datelor:",
      AcordAltex: {
    ...
    NumePozitie: "Coordonator Regional Transport",
    Orase: ["Bucuresti"],
    Email: {
      MailTo: "hrlogistica@altex.ro",
      Subject: "[COORDONATOR REGIONAL TRANSPORT]",
      BodyHeader: "Salut,%0D%0ATe rugam sa atasezi acum CV tau pentru pozitia: ",
      BodyContent: "%0D%0A%0D%0ALasa-ne si numarul tau de telefon aici: 07XX.XXX.XXX%0D%0AIn masura in care CV atasat se potriveste rolului un consultant Resurse Umane te va contacta.",
      BodyFooter: "%0D%0A%0D%0AIti multumim pentru interesul acordat companiei Altex Romania.%0D%0AEchipa Resurse Umane%0D%0A"
    },
